# Registrar n8n.domoticore.co en Route 53 (misma IP que la EC2)
# Uso: .\infra\5c-route53-n8n.ps1
# Requiere: AWS CLI configurado, mismo HostedZoneId que mcp.domoticore.co

$ErrorActionPreference = "Stop"
$ScriptDir = $PSScriptRoot
$StackName = "mcp-hub-infra"
$RecordName = "n8n.domoticore.co"
...
$ChangeBatchPath = Join-Path $ProjectRoot "infra\route53-n8n-record-temp.json"
$ChangeBatch = @"
{
  "Changes": [
    {
...
try {
    ...
    aws route53 change-resource-record-sets --hosted-zone-id $HostedZoneId --change-batch file://infra/route53-n8n-record-temp.json
